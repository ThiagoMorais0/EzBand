...
@Setter
@Entity
@DiscriminatorValue("ENSAIO_RECUSADO_PELO_ESTUDIO")
@NoArgsConstructor
public class EnsaioRecusadoPeloEstudio extends Notificacao {

    private Long idEnsaio;

    public EnsaioRecusadoPeloEstudio(Ensaio ensaio, Estudio estudio, String motivo) {
        super.setLida(false);
        super.setPermiteResposta(false);
        super.setTitulo("Ensaio recusado");
        String msg = "O estúdio \"" + estudio.getNome() + "\" recusou seu ensaio agendado para " +
    ...
    public String getTipoNotificacao() {
        return "ENSAIO_RECUSADO_PELO_ESTUDIO";
    }
}
